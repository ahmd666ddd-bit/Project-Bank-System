...
private:
    ...
    static stLogInRegisterRecord _ConvertLogInRecordLinetoRecord(string Line, string Seperator = "#//#")
    {
        stLogInRegisterRecord LogInRegisterRecord;

        vector <string> vLogInRegisterDate = clsString::Split(Line, Seperator);
        LogInRegisterRecord.DateTime = vLogInRegisterDate[0];
...
public:
    ...
    static  vector <stLogInRegisterRecord> GetRegisterInLoginList()
    {
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                ...
                stLogInRegisterRecord LogInRegisterRecord = _ConvertLogInRecordLinetoRecord(Line);
